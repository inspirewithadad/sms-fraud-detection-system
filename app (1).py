...
user_message = st.text_area("Enter your SMS message:", height=150 )
...
if st.button("🔍 Analyse SMS"):
     ...
     if user_message.strip() == "":
          ...
          svm_prob = svm_model.predict_proba(message_vector)[0]
          ...
          with col3:
               ...
               st.progress(float(max(svm_prob)))
               st.write(f"Confidence: {max(svm_prob)*100:.2f}%")
